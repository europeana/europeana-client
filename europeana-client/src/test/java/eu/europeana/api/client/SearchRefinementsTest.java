...
public class SearchRefinementsTest {
	...
	public void testQueryRefinements() throws IOException, EuropeanaApiProblem {
		...
		Api2Query europeanaQuery = new Api2Query(
				//"\"05811_L_RO_CIMEC_ese\"");
				"\"05812_L_RO_CIMEC_ese\"");
		...
		String encodedUrl = "http://www.europeana.eu/api/v2/search.json?query=what%3A%28building%29+AND+europeana_collectionName%3A%28%2205812_L_RO_CIMEC_ese%22%29&qf=NOT+gips&qf=NOT+capitel&rows=1&start=1&wskey=" + europeanaClient.getApiKey();
